...
<body>
    <div id="wrap">
    	...
    	<div class="container">
            ...
            <div class="row">
                <div class="col-md-3">
                    <img src="../assets/images/bg.jpg" alt="Eu e ela" class="thumbnail">
                </div>
                <div class="col-md-9">
                    <section>
                        ...
                        <p>Si u mundo tá muito paradis? Toma um mé que o mundo vai girarzis! Praesent malesuada urna nisi, quis volutpat erat hendrerit non. Nam vulputate dapibus. Mais vale um bebadis conhecidiss, que um alcoolatra anonimis. Tá deprimidis, eu conheço uma cachacis que pode alegrar sua vidis. Manduma pindureta quium dia nois paga. Cevadis im ampola pa arma uma pindureta. A ordem dos tratores não altera o pão duris. Casamentiss faiz malandris se pirulitá.</p>
