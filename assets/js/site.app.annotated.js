 ...
 * @author felipe.leao
 */
simulador.controller('ProjetoController', ['$scope', '$log', '$filter', 'modalAPI', 'utilAPI', function ($scope, $log, $filter, modalAPI, utilAPI) {
...
simulador.factory("modalCarregamentoAPI", ['$q', '$http', '$uibModal', '$log', '$interval', 'MODAL', function($q, $http, $uibModal, $log, $interval, MODAL){
