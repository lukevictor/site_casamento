...
var app = angular.module('app', ['ui.bootstrap', 'ngAnimate', 'ngSanitize', 'timer', 'angular-moment', 'angularjs-dropdown-multiselect']);
 ...
 * @author felipe.leao
 */
app.controller('LandingController', ['$scope', '$log', function ($scope, $log) {

    $scope.dataCasamento = moment("2020-10-10");

    /**
     * Metodo de inicializacao da pagina
     */
    $scope.init = function(){
        $log.debug($scope.dataCasamento);
    };
